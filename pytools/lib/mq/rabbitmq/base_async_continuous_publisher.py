...
class BaseAsyncContinuousPublisher(object):
    """This is an AsyncPublisher publisher that will handle unexpected interactions
...
def main():
    ...
    base_async_publisher = BaseAsyncContinuousPublisher('amqp://guest:guest@localhost:5672/%2F', debug=True)
    try:
        base_async_publisher.run()
    except KeyboardInterrupt:
        base_async_publisher.stop()
